---
name: council
description: "Use when multiple valid paths exist and you need structured disagreement before choosing. — Convene a four-voice council for ambiguous decisions, tradeoffs, and go/no-go calls"
metadata:
  origin: ECC
---
