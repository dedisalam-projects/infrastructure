---
name: growth-log
description: "Use when a complex task, failure, or when reviewing what was learned. Teaches how to write growth logs that extract reusable patterns — not diary entries."
metadata:
  version: 1.1.0
  origin: ECC
---
...
### Rule 2: The Bole Principle (Talent Scout Principle)
