---
name: repo-scan
description: "Use when repo-scan must be installed before running its cross-stack source-code asset audit; this ECC pointer does not perform the audit itself. — Bootstrap pointer that installs the external repo-scan skill from a pinned, reviewable commit"
metadata:
  origin: community
---
...
> [!IMPORTANT]
> **Rule Adherence**: Always strictly follow the `repo-scan` conventions outlined above to ensure workspace consistency and prevent regressions.
