---
name: dmux-workflows
description: "Use when running multiple agent sessions in parallel or coordinating multi-agent development workflows. — Multi-agent orchestration using dmux (tmux pane manager for AI agents). Patterns for parallel agent workflows across Claude Code, Codex, OpenCode, and other harnesses"
---
...
> [!IMPORTANT]
> **Rule Adherence**: Always strictly follow the `dmux-workflows` conventions outlined above to ensure workspace consistency and prevent regressions.
