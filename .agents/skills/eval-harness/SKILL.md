---
name: eval-harness
description: "Use when a Claude Code workflow needs a formal eval before it is trusted or changed. — Formal evaluation framework for Claude Code sessions implementing eval-driven development (EDD) principles"
metadata:
  origin: ECC
