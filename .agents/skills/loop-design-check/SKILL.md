...
> [!IMPORTANT]
> **Rule Adherence**: Always strictly follow the `loop-design-check` conventions outlined above to ensure workspace consistency and prevent regressions.
