...
> [!IMPORTANT]
> **Rule Adherence**: Always strictly follow the `parallel-execution-optimizer` conventions outlined above to ensure workspace consistency and prevent regressions.
