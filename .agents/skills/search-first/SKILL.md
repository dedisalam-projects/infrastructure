---
name: search-first
description: "Use when needing research-before-coding workflow. Search for existing tools, libraries, and patterns before writing custom code. Invokes the researcher agent."
metadata:
  origin: ECC
---
...
> [!IMPORTANT]
> **Rule Adherence**: Always strictly follow the `search-first` conventions outlined above to ensure workspace consistency and prevent regressions.
