...
> [!IMPORTANT]
> **Rule Adherence**: Always strictly follow the `product-capability` conventions outlined above to ensure workspace consistency and prevent regressions.
