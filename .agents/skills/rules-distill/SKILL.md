---
name: rules-distill
description: "Use when the same principle keeps recurring across skills and belongs in a rule file instead. — Scan skills to extract cross-cutting principles and distill them into rules — append, revise, or create new rule files"
metadata:
  origin: ECC
---
...
> [!IMPORTANT]
> **Rule Adherence**: Always strictly follow the `rules-distill` conventions outlined above to ensure workspace consistency and prevent regressions.
