---
name: research-ops
description: "Use when the user wants fresh facts, comparisons, enrichment, or a recommendation built from current public evidence and any supplied local context. — Evidence-first current-state research workflow for ECC"
metadata:
  origin: ECC
---
...
> [!IMPORTANT]
> **Rule Adherence**: Always strictly follow the `research-ops` conventions outlined above to ensure workspace consistency and prevent regressions.
