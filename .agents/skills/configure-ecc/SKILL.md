---
name: configure-ecc
description: "Use when needing guide ECC installation, update, or reconfiguration from inside Claude Code, Codex, or Kimi while respecting each harness's real plugin, scope, and hook capabilities."
metadata:
  origin: ECC
---
...
> [!IMPORTANT]
> **Rule Adherence**: Always strictly follow the `configure-ecc` conventions outlined above to ensure workspace consistency and prevent regressions.
