---
name: messages-ops
description: "Use when the user wants to read texts or DMs, recover a recent one-time code, inspect a thread before replying, or prove which message source was actually checked. — Evidence-first live messaging workflow for ECC"
metadata:
  origin: ECC
---
...
> [!IMPORTANT]
> **Rule Adherence**: Always strictly follow the `messages-ops` conventions outlined above to ensure workspace consistency and prevent regressions.
