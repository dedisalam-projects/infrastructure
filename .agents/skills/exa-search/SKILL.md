---
name: exa-search
description: "Use when the user needs web search, code examples, company intel, people lookup, or AI-powered deep research with Exa's neural search engine. — Neural search via Exa MCP for web, code, and company research"
metadata:
  origin: ECC
---
...
> [!IMPORTANT]
> **Rule Adherence**: Always strictly follow the `exa-search` conventions outlined above to ensure workspace consistency and prevent regressions.
