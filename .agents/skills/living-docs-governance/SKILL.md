...
> [!IMPORTANT]
> **Rule Adherence**: Always strictly follow the `living-docs-governance` conventions outlined above to ensure workspace consistency and prevent regressions.
