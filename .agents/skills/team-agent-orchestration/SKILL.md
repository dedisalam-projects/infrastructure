...
description: "Use when coordinating an agent squad with work items, ownership, Kanban, and merge gates. — Run team-based orchestration for agent squads using work items, ownership, agent Kanban, merge gates, and control pane handoffs"
metadata:
  origin: ECC
---
...
> [!IMPORTANT]
> **Rule Adherence**: Always strictly follow the `team-agent-orchestration` conventions outlined above to ensure workspace consistency and prevent regressions.
