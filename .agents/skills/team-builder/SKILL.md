---
name: team-builder
description: "Use when composing and dispatching a parallel team of agents for a task. — Interactive agent picker for composing and dispatching parallel teams"
metadata:
  origin: community
---
...
> [!IMPORTANT]
> **Rule Adherence**: Always strictly follow the `team-builder` conventions outlined above to ensure workspace consistency and prevent regressions.
