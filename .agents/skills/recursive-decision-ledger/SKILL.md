...
> [!IMPORTANT]
> **Rule Adherence**: Always strictly follow the `recursive-decision-ledger` conventions outlined above to ensure workspace consistency and prevent regressions.
