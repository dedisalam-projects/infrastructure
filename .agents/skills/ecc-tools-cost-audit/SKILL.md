...
description: "Use when investigating runaway PR creation, quota bypass, premium-model leakage, duplicate jobs, or GitHub App cost spikes in the ECC Tools repo. — Evidence-first ECC Tools burn and billing audit workflow"
metadata:
  origin: ECC
---
...
> [!IMPORTANT]
> **Rule Adherence**: Always strictly follow the `ecc-tools-cost-audit` conventions outlined above to ensure workspace consistency and prevent regressions.
