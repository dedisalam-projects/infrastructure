...
> [!IMPORTANT]
> **Rule Adherence**: Always strictly follow the `ecc-recipes` conventions outlined above to ensure workspace consistency and prevent regressions.
