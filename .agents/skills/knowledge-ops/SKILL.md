---
name: knowledge-ops
description: "Use when the user wants to save, organize, sync, deduplicate, or search across their knowledge systems. — Knowledge base management, ingestion, sync, and retrieval across multiple storage layers (local files, MCP memory, vector stores, Git repos)"
metadata:
  origin: ECC
---
...
> [!IMPORTANT]
> **Rule Adherence**: Always strictly follow the `knowledge-ops` conventions outlined above to ensure workspace consistency and prevent regressions.
