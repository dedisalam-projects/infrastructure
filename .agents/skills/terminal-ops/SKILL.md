---
name: terminal-ops
description: "Use when the user wants a command run, a repo checked, a CI failure debugged, or a narrow fix pushed with exact proof of what was executed and verified. — Evidence-first repo execution workflow for ECC"
metadata:
  origin: ECC
---
...
> [!IMPORTANT]
> **Rule Adherence**: Always strictly follow the `terminal-ops` conventions outlined above to ensure workspace consistency and prevent regressions.
