---
name: email-ops
description: "Use when the user wants to organize email, draft or send through the real mail surface, or prove what landed in Sent. — Evidence-first mailbox triage, drafting, send verification, and sent-mail-safe follow-up workflow for ECC"
metadata:
  origin: ECC
---
...
> [!IMPORTANT]
> **Rule Adherence**: Always strictly follow the `email-ops` conventions outlined above to ensure workspace consistency and prevent regressions.
