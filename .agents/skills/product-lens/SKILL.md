---
name: product-lens
description: "Use when needing use this skill to validate the 'why' before building, run product diagnostics, and pressure-test product direction before the request becomes an implementation contract."
metadata:
  origin: ECC
---
...
> [!IMPORTANT]
> **Rule Adherence**: Always strictly follow the `product-lens` conventions outlined above to ensure workspace consistency and prevent regressions.
