---
name: skill-scout
description: "Use when the user wants to create, build, fork, or find a skill for a workflow. — Search existing local, marketplace, GitHub, and web skill sources before creating a new skill"
metadata:
  origin: community
---
