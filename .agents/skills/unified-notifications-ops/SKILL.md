...
description: "Use when the real problem is alert routing, deduplication, escalation, or inbox collapse. — Operate notifications as one ECC-native workflow across GitHub, Linear, desktop alerts, hooks, and connected communication surfaces"
metadata:
  origin: ECC
---
...
> [!IMPORTANT]
> **Rule Adherence**: Always strictly follow the `unified-notifications-ops` conventions outlined above to ensure workspace consistency and prevent regressions.
