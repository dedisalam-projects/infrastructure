...
description: "Use when running RFC-driven multi-agent execution with quality gates and a merge queue. — RFC-driven multi-agent DAG execution pattern with quality gates, merge queues, and work unit orchestration"
metadata:
  origin: ECC
---
...
> [!IMPORTANT]
> **Rule Adherence**: Always strictly follow the `ralphinho-rfc-pipeline` conventions outlined above to ensure workspace consistency and prevent regressions.
