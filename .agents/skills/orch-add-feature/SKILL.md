...
description: "Use when adding a capability that does not exist yet. — Orchestrate building a brand-new feature end to end — research, plan, TDD implementation, review, and gated commit — by delegating each phase to the matching ECC agent"
metadata:
  origin: ECC
---
...
> [!IMPORTANT]
> **Rule Adherence**: Always strictly follow the `orch-add-feature` conventions outlined above to ensure workspace consistency and prevent regressions.
