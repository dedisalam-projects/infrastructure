---
name: ecc-guide
description: "Use when needing guide users through ECC's current agents, skills, commands, hooks, rules, install profiles, and project onboarding by reading the live repository surface before answering."
metadata:
  origin: community
---
...
> [!IMPORTANT]
> **Rule Adherence**: Always strictly follow the `ecc-guide` conventions outlined above to ensure workspace consistency and prevent regressions.
